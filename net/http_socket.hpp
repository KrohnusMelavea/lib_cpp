...
namespace net {
 ...
 public:
  ...
  static stl::status_type<net::socket_error_code, net::http_socket> create_server(u32 const host, u16 const port);
  static stl::status_type<net::socket_error_code, net::http_socket> create_client(u32 const host, u16 const port);
